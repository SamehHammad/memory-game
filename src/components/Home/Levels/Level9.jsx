...
import q from "../../../assets/food/q.jpg";
import m1 from "../../../assets/food/1.jpeg";
import m2 from "../../../assets/food/2.jpeg";
import m3 from "../../../assets/food/3.jpeg";
import m4 from "../../../assets/food/4.jpeg";
import m5 from "../../../assets/food/5.jpg";
import m6 from "../../../assets/food/6.jpg";
import m7 from "../../../assets/food/7.jpg";
import m8 from "../../../assets/food/8.jpg";

import "../game.css";
import Pic from "../Pic";

const Level9 = ({ setLevel,score,setScore }) => {
  ...
  useEffect(() => {
    if (score >= 4400) setLevel(10);
    else setLevel(9)
  }, [score]);
  return (
    <>
       <h1>
          Level <span style={{ color: "red" }}>9</span>
        </h1>
